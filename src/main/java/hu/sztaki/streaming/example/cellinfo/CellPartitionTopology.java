...
//  		        .withSyncPolicy(syncPolicy);
  		...
  		builder.setSpout("spoutInfo", new RandomCellInfoSpout(infoSpoutSleep, numOfCells), infoSpoutParallelism);
  		builder.setSpout("spoutQuery", new RandomCellQuerySpout(querySpoutSleep, numOfCells, queryLastMillis), querySpoutParallelism);
  		builder.setBolt("cellInfo", new CellPartitionBolt(unitLength, 10000, 5000), cellBoltParallelism)
      			.fieldsGrouping("spoutInfo", new Fields("cellId"))
                .fieldsGrouping("spoutQuery", new Fields("cellId"));
//  		builder.setBolt("hdfsBolt", hdfsBolt, 5)
//  				.fieldsGrouping("cellinfo", new Fields("cellId"));
